...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { description: @tarea.description, title: @tarea.title, ubicacion: @tarea.ubicacion } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { description: @tarea.description, title: @tarea.title, ubicacion: @tarea.ubicacion } }
